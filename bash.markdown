...
sleep 4
xmodmap ~/.Xmodmap
[aminra1@LAP-CA-AMINRA1 ~ (⎈|sign-internal-teal:sign)]$ cat .Xmodmap 
clear control
clear mod1
...
gb() { echo “gb => git branch”; git branch; }
gc() { echo “gc => git commit -m ‘$*’”; git commit -m “$*”; }
gac() { echo “gac => git add -A && git commit -m ‘$*’”; git add -A && git commit -m “$*”; }
gp() { echo “gp => git push”; git push; }
gd() { echo “gd => git diff ‘$*’”; git diff “$*”; }
go() { echo “go => git checkout ‘$*’ && git branch”; git checkout “$*” && git branch; }
...
# idea
export PATH="$PATH:~/Downloads/idea-IU-222.4345.14/bin"
export KUBECONFIG=/home/aminra1/oss-eks-turing
